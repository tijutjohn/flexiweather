package com.iblsoft.flexiweather.net.events
{
	...
	public class UniURLLoaderErrorEvent extends Event
	{
		...
		public function UniURLLoaderErrorEvent(
				type: String, result: Object, request: URLRequest, associatedData: Object, error: String = null,
		...
		{
			return new UniURLLoaderErrorEvent(type, m_result, m_request, m_associatedData, m_errorString, bubbles, cancelable);
		}
