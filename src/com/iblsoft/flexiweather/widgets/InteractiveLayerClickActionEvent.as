package com.iblsoft.flexiweather.widgets
{
	...
	public class InteractiveLayerClickActionEvent extends Event
	{
		...
		public function InteractiveLayerClickActionEvent(
				type:String, bubbles:Boolean=false, cancelable:Boolean=false)
		{
			super(type, bubbles, cancelable);
		}
		
		internal function setup(iw: InteractiveWidget, mouseEvent: MouseEvent = null):
				InteractiveLayerClickActionEvent
		{
			if(mouseEvent != null) {
