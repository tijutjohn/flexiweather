package com.iblsoft.flexiweather.widgets.controls.tabbar.layouts
{
	...
	/**
	 *  The InteractiveVerticalButtonBarLayout class is a layout specifically designed for the
	 ...
	 */
	public class InteractiveVerticalButtonBarLayout extends LayoutBase
	{
		public function InteractiveVerticalButtonBarLayout()
		{
			super();
		}
		...
		override public function updateDisplayList(width:Number, height:Number):void
		{
			...
			var excessSpace:Number = width - totalPreferredHeight - gap * (elementCount - 1);
