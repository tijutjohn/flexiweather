package com.iblsoft.flexiweather.widgets.controls.panzoom
{	
//	import com.adobe.utils.mousewheel.MouseWheelEnabler;
//	import com.greensock.TweenLite;
	
	import com.iblsoft.flexiweather.widgets.controls.panzoom.events.PanZoomEvent;
	 ...
	 */
	[Event(name="zoom", type="com.iblsoft.flexiweather.widgets.controls.panzoom.events.PanZoomEvent")]
	/**
	 * Dispatched when the user is zooming panning or scrolling
	 * 
	 * @eventType org.rockholla.events.PanZoomEvent.PAN
	 */
	[Event(name="pan", type="com.iblsoft.flexiweather.widgets.controls.panzoom.events.PanZoomEvent")]
...
//			MouseWheelEnabler.init(stage);
		...
		protected function _onMouseUp(event:Event):void 
		{
			...
			x = this._contentTopLeft.x;
			y = this._contentTopLeft.y;
