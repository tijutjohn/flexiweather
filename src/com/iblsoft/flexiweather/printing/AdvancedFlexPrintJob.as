package com.iblsoft.flexiweather.printing
{
	 ...
	 */
	public class AdvancedFlexPrintJob
	{
		//--------------------------------------------------------------------------
		//
		//  Constructor
		 ...
		 *  @productversion Flex 3
		 */
		public function AdvancedFlexPrintJob()
		{
			super();
		}
		...
		public function get orientation(): String
		{
			...
			return PrintJobOrientation.PORTRAIT;
...
//		}
								  ...
								  scaleType:String = "matchWidth"):void
		{
			...
			else
			{
				...
				objWidth = getObjectWidth(obj as UIComponent);
				objHeight = getObjectHeight(obj as UIComponent);
				if (FlexVersion.compatibilityVersion >= FlexVersion.VERSION_4_0)
				{
					objWidth *= obj.scaleX;
					objHeight *= obj.scaleY;
			...
			if (obj.rotation == 90)
			{
				widthRatio = _pageWidth/objHeight;
				heightRatio = _pageHeight/objWidth;
			}
		...
		private function getObjectWidth(obj:UIComponent): Number
		{
			var w: Number = obj.getLayoutBoundsWidth();
			return w;
		}
		private function getObjectHeight(obj:UIComponent): Number
		{
			var h: Number = obj.getLayoutBoundsHeight();
			return h;
