package com.iblsoft.flexiweather.symbology
{
	...
	public class FrontCurveRenderer extends DistanceMarkingCurveRenderer
	{
		...
		function FrontCurveRenderer(g: Graphics, i_color: uint, i_colorSecondary: uint, i_markType: uint)
		{
			super(g);
			mi_color = i_color;
		...
		override public function finished(x: Number, y: Number): void
		{
			...
			for each(var mark: Mark in ml_markPoints) {
				...
				case 2:
					...
					case 0: hemicircle(mark.pt, mark.vDiff, mark.vNormal, mi_color); break;
					case 1: break;
					case 2: triangle(mark.pt, mark.vDiff, mark.vNormal, mi_color); break;
					case 3: break;
					}
					break;
				case 3:
					switch(i_markCounter % 8) {
					case 1: hemicircle(mark.pt, mark.vDiff, mark.vNormal, mi_color); break;
					case 5: triangle(mark.pt, mark.vDiff, mark.vNormal, mi_colorSecondary -1, -1); break;
					}
				}
				++i_markCounter;
			}
