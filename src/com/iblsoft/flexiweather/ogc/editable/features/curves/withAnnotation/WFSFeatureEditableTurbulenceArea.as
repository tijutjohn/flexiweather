...
class TurbulenceAreaSprite extends WFSFeatureEditableSpriteWithAnnotation
{
	...
	override public function getPointsForLineSegmentApproximationOfBounds(): Array
	{
		...
		var iw: InteractiveWidget = turbulenceArea.master.container;

		//distanceValidator, pixelDistanceValidator, datelineBetweenPixelPositions
		var pts: Array = CubicBezier.calculateHermitSpline(points, turbulenceArea.isCurveClosed(), iw.pixelDistanceValidator, iw.datelineBetweenPixelPositions);
