...
class IcingAreaSprite extends WFSFeatureEditableSpriteWithAnnotation
{
	...
	override public function getPointsForLineSegmentApproximationOfBounds(): Array
	{
		...
		var iw: InteractiveWidget = icingArea.master.container;

		//distanceValidator, pixelDistanceValidator, datelineBetweenPixelPositions
		var pts: Array = CubicBezier.calculateHermitSpline(points, icingArea.isCurveClosed(), iw.pixelDistanceValidator, iw.datelineBetweenPixelPositions);
