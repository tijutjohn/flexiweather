package com.iblsoft.flexiweather.ogc
{
	...
	public interface ISynchronisedObject
	{
		...
		function hasSynchronisedVariable(s_variableId: String, b_onlySynchronised: Boolean = true): Boolean;
		/**
		 * Returns value of synchronised variable s_variableId.
		 * @return	null if s_variableId is unknown or its value is not available.
		 **/
		function getSynchronisedVariableValue(s_variableId: String, b_checkGlobalSynchronization: Boolean = true): Object;
		/**
		 * Returns array of all possible values for synchronised variable s_variableId.
		 * @return	null if s_variableId is unknown.
		 */
		function getSynchronisedVariableValuesList(s_variableId: String, b_checkGlobalSynchronization: Boolean = true): Array;

		function getSynchronisedVariableUnitsName(s_variableId: String): String

		function getSynchronisedVariableUnitSymbolsName(s_variableId: String): String
